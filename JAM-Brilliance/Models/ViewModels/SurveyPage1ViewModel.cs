...
using JAM.Brilliance.Validators;
...
namespace JAM.Brilliance.Models.ViewModels
{
    public class SurveyPage1ViewModel : SurveyViewModelBase
    {
        ...
        [Display(ResourceType = typeof(SurveyTexts), Name = "Signup_Name")]
        public string Name { get; set; }

        [Required(ErrorMessage = "{0} måste anges")]
        [StringLength(15, ErrorMessage = "{0} måste vara minst {2} tecken långt.", MinimumLength = 4)]
        [DataType(DataType.PostalCode)]
        [Display(ResourceType = typeof(SurveyTexts), Name = "Signup_PostalCode")]
        ...
        [StringLength(150, ErrorMessage = "{0} måste vara minst {2} tecken långt.", MinimumLength = 2)]
        [DataType(DataType.Text)]
        [Display(ResourceType = typeof(SurveyTexts), Name = "Signup_Country")]
        ...
        [Display(ResourceType = typeof(SurveyTexts), Name = "Signup_Email")]
        ...
        [Display(ResourceType = typeof(SurveyTexts), Name = "Signup_Upload")]
